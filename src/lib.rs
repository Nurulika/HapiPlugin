...
#[derive(Debug)]
pub struct HapiPluginProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HapiPluginProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HapiPlugin processing");
    
    let mut processor = HapiPluginProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HapiPluginProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HapiPluginProcessor::new(false);
